...
public class UserTasksCompletetionCollector implements Collector<Task, Map<User, Map<Task, Boolean>>, Map<User, Map<Task, Boolean>>> {
    ...
    public UserTasksCompletetionCollector(boolean useDelay) {
        this.useDelay = useDelay;
    }

    public static UserTasksCompletetionCollector toTaskStatusStatsMap(boolean useDelay) {
        return new UserTasksCompletetionCollector(useDelay);
    }
